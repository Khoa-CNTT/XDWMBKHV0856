            ...
            <Row gutter={16}>
                        ...
                        <div className="tags-wrapper">
                            {detailCourse.fields?.length > 0 ? (
                                detailCourse.fields.map((field, index) => (
                                    <Tag key={index} color="magenta" className="px-3 py-1 border rounded-pill ant-input">
                                        {field.name}
                                    </Tag>
                                ))
                            ) : (
                ...
                <Col xs={12}>
                    <div className="card-item">
                        ...
                        <div className="tags-wrapper">
                            {detailCourse.skills?.length > 0 ? (
                                detailCourse.skills.map((skill, index) => (
                                    <Tag key={index} color="volcano" className="px-3 py-1 border rounded-pill ant-input">
                                        {skill.name}
                                    </Tag>
                                ))
                            ) : (
                ...
                <Col xs={24}>
                    <div className="card-item">
                        ...
                        <ContentCourse chapters={detailCourse.chapters} id={detailCourse.id}/>
                    </div>
                </Col>   
            </Row>
        </Card>
