...
const ForgotPassword = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (!userExists) {
                setError("This email is not registered. Please check your registered email.");
                    ...
                    <div className="bg-card rounded-lg shadow-sm p-8 w-full relative z-10">
                        ...
                        {isPasswordStep && (
                            ...
                            <form onSubmit={handlePasswordChange} className="space-y-4">
                                {errorMessage && (
                                    <div className="text-destructive text-sm my-4">{errorMessage}</div>
                                )}
                        ...
                        {success && (
                            <p className="text-green-600 mt-2 text-center">Password reset successfully. Redirecting...</p>
                        )}
                    </div>
                </motion.div>
            </div>
