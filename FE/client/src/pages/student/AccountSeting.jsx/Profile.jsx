    ...
    <div className="mt-5">
      <div className="max-w-[950px] bg-white rounded-lg shadow overflow-hidden">
        <div className="relative">
          ...
          >
            <CiEdit className="text-2xl text-gray-700" />
          </button>
          <img
            src={background}
            alt="Background"
        ...
        <div className="px-8 flex">
          ...
          <div className="ml-6 flex flex-col justify-start">
            <input
              type="text"
              name="fullName"
              defaultValue={user.fullName || "Updating..."}
              {...register("fullName")}
              disabled={!isEditing}
            ...
            <input
              type="text"
              name="bio"
              defaultValue={user.bio || "Updating..."}
              {...register("bio")}
              disabled={!isEditing}
        ...
        <form className="px-8 pb-6" onSubmit={handleSubmit(onSubmit)}>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-1">
              ...
              <input
                type="text"
                name="address"
                defaultValue={user.address || "Updating..."}
                {...register("address")}
                disabled={!isEditing}
                className="w-full focus:outline-none border-none rounded-sm bg-transparent py-2 focus:border-red-500 transition-colors"
              />
            ...
            <div className="space-y-1">
              ...
              <input
                type="tel"
                name="phone"
                defaultValue={user.phone || "Updating..."}
                {...register("phone")}
                disabled={!isEditing}
                className="w-full focus:outline-none border-none rounded-sm bg-transparent py-2 focus:border-red-500 transition-colors"
              />
