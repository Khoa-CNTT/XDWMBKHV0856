...
import { Button, Card, Checkbox, Col, Form, Input, List, Modal, Row, Select } from "antd";
  ...
  return <>
    {loading ? <LoadingPage/> : <div>
      <div className="flex justify-between items-center w-full">
        <div className="flex flex-wrap gap-4 items-center w-full p-4 bg-white shadow-md rounded-lg">
          {/* Các nút chức năng */}
          ...
          <Input.Search
            ...
            className="w-[200px] sm:w-[250px] md:w-[300px]"
          />
          {/* Đẩy nút DeleteFilled ra ngoài cùng bên phải */}
          {Object.values(checkedItemsField).some((value) => value) && (
            <Button
              type="text"
              className="text-3xl text-red-300 hover:!text-red-500 ml-auto"
            ...
            <List.Item key={field.id}>
              <Card title={
                <Row justify="space-between" align="middle">
                  <div className="flex title-field">
                    <Checkbox className="me-2" checked={checkedItemsField[field.name] || false}
                  ...
                  <div className="col">
                    <Row>
                      <Col>
                        <Button type="text" style={{ color: "orange" }} onClick={() => showFieldModal("Edit", field)}>
                          <EditFilled />
                        </Button>

                      </Col>
                      <Col>
                        <Button type="text" danger onClick={() => showFieldModal("Delete", field)}>
                          <DeleteFilled />
                        </Button>
                      </Col>
                    </Row>
                ...
                <div className={`flex justify-between items-center ${skills.length === 0 ? 'hidden-section' : ''}`}>
                  <Checkbox
                    className="mb-2 p-2"
